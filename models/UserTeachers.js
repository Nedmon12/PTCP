...
UserTeachersSchema.pre("save", async function (next) {
...
UserTeachersSchema.methods.matchPassword = async function (password) {
  return await bcrypt.compare(password, this.password);
};

UserTeachersSchema.methods.getSignedJwtToken = function () {
  return jwt.sign({ id: this._id }, process.env.JWT_SECRET, {
    expiresIn: process.env.JWT_EXPIRE,
  });
};
UserTeachersSchema.methods.getResetPasswordToken = function () {
