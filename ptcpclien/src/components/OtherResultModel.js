...
export default function ExamResultModel({student,setExamResultModal, subject}) {
    ...
    <div className='flex h-screen justify-center items-center ' >
        ...
        <div className='basis-5/6' >
            ...
            <input required  id="marknumber" type="text" placeholder="Handing writting"className=" rounded-sm ml-4 PostInput pl-3 placeholder-cyan-500 w-[24vw] border  h-10"/>
            </div>
            <div className='mt-6  flex flex-row px-4'>
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-marknumber">
                Out of
            </label>
            <input required  id="marknumber" type="number" placeholder="5"className=" rounded-sm ml-4 PostInput pl-3 placeholder-cyan-500 w-[24vw] border  h-10"/>
            ...
            <input required  id="number" type="number" placeholder="4"className=" rounded-sm ml-4 PostInput pl-3 placeholder-cyan-500 w-[24vw] border  h-10"/>
             </div>   
