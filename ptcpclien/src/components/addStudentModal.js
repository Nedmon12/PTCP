  ...
  return (
    <div className='bg-zinc-700 opacity-95 fixed inset-0 z-50' >
        <div className='flex h-screen justify-center items-center ' >
            <div className='bg-white border-gray-500 rounded-xl flex flex-col h-[35vw] w-[35vw]' >
                ...
                <form class="flex flex-wrap mb-6" onSubmit={addStudent}>
                    <div class="w-full px-3  border-b border-slate-200">
                        <label class="block tracking-wide text-gray-500 text-base m-3  " for="grid-password">
                            Add Student By Full name
                        </label>
                        <input ref={firstname} class="ml-2 appearance-none block w-[33vw] bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="name" placeholder="Girum"></input>
                        <input ref={lastname} class="ml-2 appearance-none block w-[33vw] bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="name" placeholder="Gizachew"></input>
                        <p class="text-gray-500 text-xs pb-3 ">Write the first and last name</p>
                    </div>
