...
const {user} = useContext(AuthContext);
  ...
  return (
    ...
    <div className='flex h-screen justify-center items-center ' >
        <div className='bg-white  border-gray-500 rounded-lg flex flex-col h-[42vw] w-[32vw] opacity-100' >
                <div className='basis-1/12 flex flex-row h-16 justify-between border-b-2 border-slate-100' >
                  ...
                  <div className='basis-2/12 flex flex-col h-[2vh] bg-gray-100  justify-center' >
                     ...
                     <div className='basis-1/12 flex flex-row-reverse justify justify-between mt-10 p-2 border-t border-slate-100' >
