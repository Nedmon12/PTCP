    ...
    <div className='flex h-screen justify-center items-center ' >
        ...
        <div className='basis-1/12 flex flex-row h-16 justify-between border-b-2 border-slate-100' >
                  ...
                  <div className='basis-10/12 p-6 border-b border-slate-200' >
                    <img className='pokeman w-[15vh] h-[15vh] bg-slate-200 border border-slate-500 mt-12 ml-40 '  src={PF+"down.png"} alt="k" />
                    ...
                    <div class="">
                     <input ref={skillname} class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-slate-500" id="inline-full-name" type="text" placeholder="Class Disturbance">
                     </input>
                    </div>
                  </div>
