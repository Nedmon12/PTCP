        ...
        <nav className='class="bg-white px-4 py-5  border-blue-100 rounded border-solid border'>
            <div className='container flex flex-wrap justify-between items-center mx-auto'>
              ...
              <div class="flex md:order-2">
                <Link href="http://localhost:3000/landingpage/subscribe">
                ...
                <Link href="http://localhost:3000/landingpage/login">
                <button type="button" class="text-cyan-500 bg-cyan-200 hover:bg-cyan-400 font-medium rounded-lg text-base px-5 py-2.5 text-center mr-2 md:mr-2">Login</button>
                </Link>
