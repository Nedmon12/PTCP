...
const {addStudent,fetchStudents,addResult,fetchattendance,behaviourfetch,addAverage,addTotalResult,fetchmykid,fetchresult,fetchresultt ,fetchmykidteacher,fetchmystudentparent,attendance,behaviourupdate,behaviourallfetch}=require("../controllers/studentManagmentController")
